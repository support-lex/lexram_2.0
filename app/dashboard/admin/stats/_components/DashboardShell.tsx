      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-5 space-y-4">
        ...
        <header className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h1 className="text-2xl font-bold text-[var(--text-primary)] tracking-tight mt-1">
              Admin overview
            </h1>
          </div>
          <div className="flex flex-col items-end gap-1.5">
            ...
            />
            <span className="flex items-center gap-1.5 text-[10px] text-[var(--text-muted)] tabular-nums">
        ...
        {data.warnings.length > 0 && (
          <div className="rounded-xl border border-[#fab219]/45 bg-[#fab219]/10 px-4 py-2.5">
        ...
        {/* ── Tab bar ─────────────────────────────────────────────────────── */}
        <nav
          className="flex items-center gap-1 overflow-x-auto border-b border-[var(--border-default)] -mb-px"
        ...
        >
          {TABS.map((t) => (
            <button
              ...
              className={`flex items-center gap-1.5 whitespace-nowrap px-3 py-2 text-xs font-semibold border-b-2 -mb-px transition-colors ${
                tab === t.key
