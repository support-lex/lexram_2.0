...
export default function BlogActions({ title, initialLikes = 0 }: Props) {
  ...
  return (
    <div className="flex items-center gap-1 sm:gap-2">
      <button
        ...
        className={`inline-flex items-center gap-1.5 px-3 h-9 rounded-full text-sm font-medium transition-all
          ${liked
            ...
            : "text-[#680318]/80 hover:bg-[#680318]/8 hover:text-[#680318]"
          }`}
      >
      ...
      <a
        href="#comments"
        className="inline-flex items-center gap-1.5 px-3 h-9 rounded-full text-sm font-medium text-[#680318]/80 hover:bg-[#680318]/8 hover:text-[#680318] transition-colors"
      >
