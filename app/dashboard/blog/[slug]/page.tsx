...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  return (
    <article className="h-full overflow-y-auto bg-[#fff0df] pb-24">
      {/* Cover */}
      ...
      <div className={`max-w-3xl mx-auto px-4 sm:px-6 ${post.cover_image_url ? "-mt-16 sm:-mt-24 relative" : "pt-10"}`}>
        ...
        <div className="mb-8 flex items-center justify-between">
          <Link
            href="/dashboard/blog"
            className="inline-flex items-center gap-1.5 px-3 h-9 rounded-full text-sm font-medium bg-[#fff7ec]/90 backdrop-blur border border-[#680318]/20 text-[#680318]/80 hover:text-[#680318] transition-colors shadow-sm"
          >
        ...
        <header className="mb-10 space-y-4">
          ...
          {post.subtitle && (
            <p className="text-lg sm:text-xl text-[#680318]/80 leading-relaxed">
              {post.subtitle}
            </p>
          )}
        ...
        {post.tags.length > 0 && (
          <div className="mt-12 flex flex-wrap gap-2">
            {post.tags.map((t) => (
              <span
                key={t}
                className="inline-block px-3 py-1 text-xs font-medium rounded-full bg-[#fff7ec] border border-[#680318]/20 text-[#680318]/80"
              >
                #{t}
              </span>
            ))}
        ...
        <div className="sticky bottom-4 z-20 mt-12 flex justify-center">
          <div className="rounded-full bg-[#fff7ec]/90 backdrop-blur shadow-lg border border-[#680318]/20 px-2 py-1">
        ...
        <section id="comments" className="mt-16 pt-10 border-t border-[#680318]/20">
          ...
          <div className="rounded-xl border border-dashed border-[#680318]/20 bg-[#fff7ec] p-8 text-center text-sm text-[#680318]/60">
