...
function EmptyFeedState({ onCompose }: { onCompose: () => void }) {
  return (
    ...
    >
      <div
        className="size-14 mx-auto rounded-2xl grid place-items-center mb-4 shadow-sm"
        style={{ background: "linear-gradient(135deg, rgba(122,31,43,0.12), rgba(122,31,43,0.04))" }}
      >
        <Sparkles className="size-6" style={{ color: MAROON }} />
      </div>
      ...
      <button
        onClick={onCompose}
        className="mt-5 text-sm font-semibold text-white px-6 py-2.5 rounded-full inline-flex items-center gap-2 hover:opacity-95 transition-all shadow-lg shadow-[#7a1f2b]/20 hover:shadow-xl hover:shadow-[#7a1f2b]/30"
        style={{ background: MAROON_GRAD }}
      >
