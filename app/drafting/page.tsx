...
function DraftingFAQ() {
  ...
  return (
    <section id="drafting-faq" className="min-h-screen py-10 md:py-12 bg-[#d8cdb8]">
  ...
  return (
    <div data-landing-v2 className="min-h-screen">
      <PageSidebarNav items={[
        { id: "drafting",              icon: FileText,      label: "Overview"  },
        { id: "drafting-features",     icon: Layers,        label: "Features"  },
        { id: "drafting-edge",         icon: GitCompare,    label: "Edge"      },
        { id: "drafting-testimonials", icon: MessageSquare, label: "Reviews"   },
        { id: "drafting-faq",          icon: HelpCircle,   label: "FAQ"       },
      ]} />
      <LandingNav />
