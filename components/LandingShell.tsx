      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 pt-14 pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr_1fr] gap-12 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-5 text-base">
              <li><Link href="/#research"       className="text-[#fff0df]/90 hover:text-[#fff0df] transition-colors">Research</Link></li>
              <li><Link href="/#drafting"       className="text-[#fff0df]/90 hover:text-[#fff0df] transition-colors">Drafting</Link></li>
              <li><Link href="/dashboard/tsr"   className="text-[#fff0df]/90 hover:text-[#fff0df] transition-colors">TSR</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 text-base">
              <li><Link href="/blog"    className="text-[#fff0df]/90 hover:text-[#fff0df] transition-colors">Blog</Link></li>
              <li><Link href="/#pricing" className="text-[#fff0df]/90 hover:text-[#fff0df] transition-colors">Pricing</Link></li>
              <li><Link href="/#faq"    className="text-[#fff0df]/90 hover:text-[#fff0df] transition-colors">FAQ</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-sm text-[#fff0df]/70">
          ...
          <div className="flex items-center gap-4">
            <Link href="/privacy"       className="hover:text-[#fff0df] transition-colors">Privacy</Link>
            <Link href="/terms"         className="hover:text-[#fff0df] transition-colors">Terms</Link>
            <Link href="/refund-policy" className="hover:text-[#fff0df] transition-colors">Refund</Link>
          </div>
        </div>
      </div>
    </footer>
