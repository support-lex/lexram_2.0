...
import { Scale, Loader2, Eye, EyeOff, Mail } from 'lucide-react';
...
export default function AuthBottomSheet({ onAuthenticated }: AuthBottomSheetProps) {
  ...
  return (
    ...
    >
      {/* Top gradient fade so content behind blends nicely */}
