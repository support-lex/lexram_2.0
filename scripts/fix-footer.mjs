...
const start = c.indexOf("function Footer()");
const end   = c.indexOf("\r\n/* ============================================================\r\n   Page", start);
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 pt-14 pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr_1fr] gap-12 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#research"       className="text-[#fff0df]/70 hover:text-[#fff0df] transition-colors">Research</a></li>
              <li><a href="#drafting"       className="text-[#fff0df]/70 hover:text-[#fff0df] transition-colors">Drafting</a></li>
              <li><a href="/dashboard/tsr"  className="text-[#fff0df]/70 hover:text-[#fff0df] transition-colors">TSR</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="/blog"    className="text-[#fff0df]/70 hover:text-[#fff0df] transition-colors">Blog</a></li>
              <li><a href="#pricing" className="text-[#fff0df]/70 hover:text-[#fff0df] transition-colors">Pricing</a></li>
              <li><a href="#faq"     className="text-[#fff0df]/70 hover:text-[#fff0df] transition-colors">FAQ</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-xs text-[#fff0df]/40">
          ...
          <div className="flex items-center gap-4">
            <a href="/privacy"       className="hover:text-[#fff0df]/70 transition-colors">Privacy</a>
            <a href="/terms"         className="hover:text-[#fff0df]/70 transition-colors">Terms</a>
            <a href="/refund-policy" className="hover:text-[#fff0df]/70 transition-colors">Refund</a>
          </div>
        </div>
      </div>
    </footer>
...
c = c.slice(0, start) + newFooter + c.slice(end);
writeFileSync(file, c, "utf8");
console.log("Done — footer replaced");
